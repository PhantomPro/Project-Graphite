        ...
        <div className="preview_wraper">
          ...
          <div className="preview_box drop_preview">
            <p style={{ lineHeight: `${lineHeight}`, padding: 20 }}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt omnis et
              itaque saepe suscipit autem architecto voluptatibus libero id impedit!
              . Sunt omnis et itaque saepe suscipit autem architecto voluptatibus
              libero id impedit!
            </p>
          </div>
        </div>
